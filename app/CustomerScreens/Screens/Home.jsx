...
import { View, FlatList, ScrollView, Dimensions, Text, RefreshControl } from 'react-native';
...
export default function HomeScreen() {
  ...
  const fetchNearestStoreMenu = async (latitude, longitude) => {
    try {
      ...
      const response = await axios.get("http://192.168.232.249:3500/api/user/nearest", {
