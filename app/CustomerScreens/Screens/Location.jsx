...
//         "https://api.naticoco.com/location/address",
//         addressData
//       );


//       if (saveResponse.status == 200 || 201) {
//         // Find the nearest store and fetch its menu
//         const nearestStoreResponse = await axios.post(
//           `https://api.naticoco.com/userapi/nearest`, {
//            latitude : location.latitude,
//            longitude : location.longitude
//           }
//         );
//         console.log("Response", nearestStoreResponse.status);
//         if (nearestStoreResponse.status == 200 || 201) {
