...
//     try {
//       const response = await axios.post('http://147.93.110.87:3500/auth/Register', data, {
//         headers: {
...
//           const otpResponse = await axios.post('http://147.93.110.87:3500/auth/generate-otp', {
...
//     console.log(otp);
//     try {
//       const response = await axios.post('http://147.93.110.87:3500/auth/verify-otp', {
//         phoneNumber: mobileNumber, // Using the full number including +91
//         otp: otp.join('')
//       });
//       if (response.status === 200) {
  ...
  const handlePostData = async () => {
    ...
    try {
      const response = await axios.post(
        "http://147.93.110.87:3500/auth/Register",
        data,
        {
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.status === 200) {
        ...
        try {
          ...
          const otpResponse = await axios.post(
            "http://147.93.110.87:3500/auth/generate-otp",
            {
              phoneNumber: mobileNumber, // Using the full number including +91
            }
          );
