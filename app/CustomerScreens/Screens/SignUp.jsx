...
export default function SignUpScreen() {
  ...
  const handlePostData = async () => {
    ...
    try {
      const response = await axios.post(
        "https://api.naticoco.com/auth/Register",
        data,
        {
          headers: {
      ...
      if (response.status === 200) {
        ...
        try {
          ...
          const otpResponse = await axios.post(
            "https://api.naticoco.com/auth/generate-otp",
            {
              phoneNumber: `+91${mobileNumber}`, // Using the full number including +91
            }
          );
  ...
  const verifyOTP = async (otp) => {
    try {
      const response = await axios.post(
        "https://api.naticoco.com/auth/verify-otp",
        {
          phoneNumber: `+91${mobileNumber}`, // Using the full number including +91
          otp: otp.join(""),
        }
